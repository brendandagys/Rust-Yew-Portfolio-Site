...
pub fn who_i_am() -> Html {
    ...
    html! {
      <div class="who-i-am container-fluid justify-content-center m-0">

        <div class="col-xs-12">
          <div class="who-i-am__text px-4 py-3 pt-4 mx-auto text-center">
            <h1 class="mb-5 mt-4 font-5xl" style="font-weight: 400; text-shadow: 3px 3px 2px gray;">{"About Me"}</h1>
